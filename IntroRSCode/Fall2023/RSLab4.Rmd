...
```{r include = FALSE}
wd="/Users/tug61163/Library/CloudStorage/OneDrive-TempleUniversity/Courses/IntroRemoteSensing/2023Fall/Class4/Class4_lab"
setwd(wd)
...
untar(tars[1]) # If you have more than one .tar file, select the index representing the file of interest
...
3. Plot the original scene and crop it to the extent of Guam only. We have to use the plotRGB function instead of ggRGB, otherwise the draw() function will not work:
...
bitMask=function(r, bit){
  v <- terra::values(r)
  v=apply(v, 1, function(i) int2bits(i, bit))
  v[v==1]=NA
  v[v==0]=1
