...
```{r include = TRUE, message=F, warning=F, eval=FALSE}
wd="/Users/tug61163/Library/CloudStorage/OneDrive-TempleUniversity/Courses/IntroRemoteSensing/2021Fall/Class6/Lab6Materials"
setwd(wd)

# create subdirectory and paste there the topCor.R function
fundir=paste0(getwd(), "/functions") 
dir.create(fundir)
source_code_dir <- fundir #The directory where all source code files are saved.
...
```{r include = TRUE, message=F, warning=F, eval=FALSE}
#topo=terrain(srtmskd, v=c('slope', 'aspect'))
