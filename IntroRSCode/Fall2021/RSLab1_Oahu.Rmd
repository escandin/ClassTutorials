...
Use the code below to unzip the file for Oahu Check the working directory again and you will see a decompressed file ("kaui_dem"). Open it as a raster object in R, and plot it. 
```{r include = TRUE, message=F, warning=F, eval=FALSE}
DEM=raster("oahu_dem")
plot(DEM)
```
...
Go to your working directory and identify the pdf file. Save the edited code (File/Save As...) and upload it in module 1 in Canvas (Upload Lab 1 here).
