---
title: 'Remote Sensing Lab 8: Image transformation and spectral indices
  in R'
...
```{r include = FALSE}
# Load screenshots
wd="/Users/tug61163/Documents/Courses/IntroRemoteSensing/2021Fall/Class8"
setwd(wd)
...
wd="/Users/tug61163/Documents/Courses/IntroRemoteSensing/2021Fall/Class8/DataNProcessing"
#dir.create(wd)
setwd(wd)
...
L8PCA=rasterPCA(L8rsz, nComp=nlayers(L8rsz)) 

# Plot each band individually
plot(L8PCA$map, col = gray.colors(100, start = 0.1, end = 0.9, gamma = 2.2, alpha = NULL), axes=FALSE)
...
L8tascap=tasseledCap(L8rsz[[-1]], sat="Landsat8OLI") # Tasseled cap
...
5. Respond the questions below based on the colors of different land covers after applying the tasseledCap() function. State briefly (40 words or less) your interpretation about those colors based on what each band represents in the tasseled cap transformation:
...
3.	Answer to the questions in point 5 (1.5 pt).
