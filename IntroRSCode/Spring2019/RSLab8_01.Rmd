...
4. Use the drawExtent() function to create an extent that includes approximately the specific study area (optional).
```{r include = TRUE, message=F, warning=F}
#e=drawExtent()
...
outdata=stack2df(inrast=L8tascap, invec=calibdata,
                 classcolname="Class")
classcolors= c("gray", "green", "blue", "yellow", "cyan", "purple", "red")
