...
4.	Type “Pennypack Park Philadelphia” and click on the suggested location. This will show a pin in the selected location in the map.
...
8. Plot the NAIP image along with the Landsat image after and before aggregation for the area covered by the extent of the NAIP image. Save the images as pdf. Use the drawExtent() function and the ext argument in the plotRGB function to zoom in into different areas of interest.
```{r include = TRUE, message=F, warning=F}
#e=drawExtent()
e=extent(naip)
plotRGB(L8agg, r = 4, g = 3, b = 2, axes = FALSE, stretch = "lin", ext=e,
        main = "Landsat True Color Composite" )
plotRGB(L8rsz, r = 4, g = 3, b = 2, axes = FALSE, stretch = "lin", ext=e,
        main = "Landsat True Color Composite" )
plotRGB(naip, r = 1, g = 2, b = 3, axes = FALSE, stretch = "lin", ext=e,
        main = "naip True Color Composite" )
```
...
plotRGB(L8agg, r = 4, g = 3, b = 2, axes = FALSE, stretch = "lin", ext=extent(naip),
        main = "Landsat True Color Composite" )
plotRGB(L8rsz, r = 4, g = 3, b = 2, axes = FALSE, stretch = "lin", ext=extent(naip),
        main = "Landsat True Color Composite" )
plotRGB(naip, r = 1, g = 2, b = 3, axes = FALSE, stretch = "lin", ext=extent(naip),
        main = "naip True Color Composite" )
dev.off()
```
...
1. Download an NAIP image including the area of Staten Island in NY from August 26 2017 by adapting the steps specified in Part A. Then modify part B to produce three PDF files for the extent of the NAIP image downloaded for Staten Island (1 pt).
...
table1=data.frame(cbind(c("Pixel size", "Sensor revisit time", 
                          ...
                          "maximum number of pixel values possible "), rep("", 5), 
                        c("","","",8,"")))
...
3. Based on the information in the table above and information in the data sources below, write below which of the two sensor datasests (Landsat 8 vs NAIP) has the highest resolution as specified below (0.5 pt):
